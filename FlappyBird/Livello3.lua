...
function Livello3:init()
	self.spazio_fra_tubi = 200
...
function Livello3:render()
	...
	love.graphics.draw(livello.tuboInAlto["image"], self.x_tubo, livello.parteDelTubo["height"]*2)
	love.graphics.draw(livello.parteDelTubo["image"], self.x_tubo, livello.parteDelTubo["height"]*3)
	love.graphics.draw(livello.parteDelTubo["image"], self.x_tubo, livello.parteDelTubo["height"]*4)
	
	livello:controlloCollisione(self.x_tubo, livello.parteDelTubo["height"], livello.parteDelTubo["height"]*2)
	self.x_tubo = self.x_tubo+self.spazio_fra_tubi
